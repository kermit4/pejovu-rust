...
struct PeerInfo {
    ...
    delay: Duration,
    anti_ddos_key_to_send_to_them: u32,
...
impl PeerInfo {
    fn new() -> PeerInfo {
        return PeerInfo {
            ...
            anti_ddos_key_to_send_to_them: 0,
        ...
        for message_in in messages {
            if (message_in["PleaseReturnThisMessage"]) != Value::Null {
                ...
                let reply = match message_in_enum {
                    ...
                    Message::PleaseAlwaysReturnThisMessage(t) => t.save_key(&mut ps, src),
...
impl PleaseAlwaysReturnThisMessage {
    fn save_key(&self, ps: &mut PeerState, src: SocketAddr) -> Vec<Message> {
        ps.peer_map
            .get_mut(&src)
            .unwrap()
            .anti_ddos_key_to_send_to_them = self.key;
        return vec![];
    }
